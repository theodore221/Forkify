...
const controlSearchResults = async function() {
    try {
        ...
        console.log(_modelJs.state.search.results.length === 0);
        if (_modelJs.state.search.results.length === 0) {
            console.log("gets here");
            (0, _resultsViewDefault.default).renderError("No recipes found for your query. Please try again!");
        }
        ...
        (0, _resultsViewDefault.default).renderError(err);
        console.log(err);
    }
};
...
const controlServings = function(newServ) {
    _modelJs.changeServings(newServ);
...
const controlBookmarks = function() {
    ...
    (0, _recipeViewJsDefault.default).update(_modelJs.state.recipe);
    console.table(_modelJs.state.bookmarks);
...
const init = function() {
    ...
    (0, _bookmarksViewDefault.default).addHandlerRender(controlRenderBookmarks);
    ...
    (0, _recipeViewJsDefault.default).addHandlerAddBookmark(controlBookmarks);
    (0, _addRecipeViewDefault.default).addHandlerUpload(controlAddRecipe);
};
init();

},{"core-js/modules/web.immediate.js":"49tUX","regenerator-runtime/runtime":"dXNgZ","./model.js":"Y4A21","../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./views/recipeView.js":"l60JC","./views/searchView.js":"9OQAM","./views/resultsView":"cSbZE","./views/paginationView":"6z7bi","./views/bookmarksView":"4Lqzq","./views/addRecipeView":"i6DNj"}],"49tUX":[function(require,module,exports) {
"use strict";
...
const loadRecipe = async function(id) {
    try {
        const url = (0, _configJs.API_URL) + "/" + id + "?key=a5554023-1180-4103-b9a4-0f3681af1442";
        data = await (0, _helpersJs.getJSON)(url);
...
const loadSearchResults = async function(keyword) {
    const url = (0, _configJs.API_URL) + `?search=${keyword}` + `&key=a5554023-1180-4103-b9a4-0f3681af1442`;
    data = await (0, _helpersJs.getJSON)(url);
    console.log(data);
...
const changeServings = function(newServ) {
...
const uploadRecipe = async function(newRecipe) {
    ...
    const url = (0, _configJs.API_URL) + `?key=a5554023-1180-4103-b9a4-0f3681af1442`;
    data = await (0, _helpersJs.sendJSON)(url, recipeData);
    const { recipe } = data.data;
    console.log(recipe);
    state.recipe = createRecipeObject(recipe);
    console.log(state.recipe);
...
class RecipeView extends (0, _viewDefault.default) {
    ...
    addHandlerServings(handler) {
        this._parentElement.addEventListener("click", function(e) {
            ...
            if (!btn) return;
            const newServ = btn.dataset.changeTo;
  ...
  <div class="recipe__details">
    ...
    <div class="recipe__info">
      ...
      <div class="recipe__info-buttons">
        <button data-change-to=${+this._data.servings - 1} class="btn--tiny btn--increase-servings">
          <svg>
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../../img/icons.svg":"cMpiy","./View":"5cUXS"}],"5cUXS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _iconsSvg = require("../../img/icons.svg");
var _iconsSvgDefault = parcelHelpers.interopDefault(_iconsSvg);
...
class PaginationView extends (0, _viewDefault.default) {
    ...
    _generateMarkup() {
      ...
      <svg class="search__icon">
        ...
        //Other Page
        if (curPage > 1) return `<button data-goto=${curPage - 1} class="btn--inline pagination__btn--prev">
        <svg class="search__icon">
          <use href="${0, _iconsSvgDefault.default}#icon-arrow-left"></use>
        </svg>
        <span>Page ${curPage - 1}</span>
...
},{"./View.js":"5cUXS","../../img/icons.svg":"cMpiy","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"i6DNj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./View");
var _viewDefault = parcelHelpers.interopDefault(_view);
